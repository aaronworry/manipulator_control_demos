...
import sys
sys.path.append('..')
from position_control.iteration import inverse_kinematics_local_frame
...
cmodel = pinocchio.buildModelFromMJCF(filename)
...
class CustomViewer:
    ...
    def run_loop(self):
        ...
        while self.is_running():
            ...
            if self.x < 0.5:
                self.x += 0.001
                new_q = inverse_kinematics_local_frame(cmodel, cdata, 6, self.new_q, self.R_x, [self.x, 0., 0.2])
